    ...
    <footer className="footer-mind py-5">
      <div className="container">
        <div className="row gy-4 align-items-start">
          ...
          {/* 6. Social Icons */}
          <div className="col-12 d-flex justify-content-md-end justify-content-center align-items-center gap-3 mt-4 mt-md-0">
        ...
        <div className="footer-bottom mt-5 d-flex flex-column flex-md-row align-items-center justify-content-between">
